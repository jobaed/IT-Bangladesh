...
?>
    <title>Abu Foyez Profile Profile</title>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="asset/img/Abul-sir.jpg" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4 class="fw-bold">Abul Faeze Mohammad Bakabillah</h4>
                      <p class="text-secondary mb-1">MCT, Azure Administrator</p>
                      <p class="text-muted font-size-sm">IsDB-BISEW IT</p>
              ...
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-secondary">linkedin.com/in/bbillah</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      Abul Faeze Mohammad Bakabillah
                    </div>
                  </div>
                  <hr>
                  <div class="row">
          ...
          <div class="experience-area">
            ...
            <div class="row my-3">
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title fw-bold">Show & Tell Consulting Limited. IsDB-BISEW</h5>
                    <p class="card-text">Network System Specialist</p>
                      <div class="card-footer text-light bg-info">
                        Aug 2008 - Present · 13 yrs 11 mos
                      </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title fw-bold">IT Bangladesh</h5>
                    <p class="card-text">Senior Cyber Specia</p>
                    <div class="card-footer text-light bg-info">
            ...
            <div class="row my-3">
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title fw-bold">Bangladesh IT Institute</h5>
                    <p class="card-text">Cloud Specialist</p>
                      <div class="card-footer text-light bg-info">
              ...
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title fw-bold">MikroTik</h5>
                    <p class="card-text">MikroTik Consultant, Asia region</p>
                    <div class="card-footer text-light bg-info">
            ...
            <div class="row my-3">
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title fw-bold">Chittagong City Corporation Computer Institute</h5>
                    <p class="card-text">Instructor [ Networking Technologies ]</p>
                      <div class="card-footer text-light bg-info">
              ...
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title fw-bold">MIPS Institute of Management & Technology</h5>
                    <p class="card-text">Instructor [ Industrial Training ]</p>
                    <div class="card-footer text-light bg-info">
