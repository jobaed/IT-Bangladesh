...
<body>
    ...
    <div class="container">
        <div class=" element-item p-3 px-5 web ecommerce1">
            <!-- 1 -->
            <h2 class="fw-bold text-center py-4">CEH - Certified Ethical Hacker</h2>
            <div id="webDesign" class="card course-item border-0 shadow mx-auto">
                ...
                <div class="course-image">
                    <img class="card-img-top" src="asset/img/hacker-2883632__340.jpg" alt="Card image cap">
                </div>
                ...
                <div class="card-body row">
                    <div class="col-md-4">
                        ...
                        <h5 class="card-title text-center fw-bold text-info pb-1 pt-5">CEH - Certified Ethical Hacker</h5>
