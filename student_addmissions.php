...
$contest = $conn->query("SELECT * FROM student_addmission WHERE status = '1' ORDER BY id DESC");
?>
...
if ($row['course'] == 1) {
    ...
    ?></td>
                        ...
                        <td>
                            ...
                            <a href='delete-admishion.php?id=<?php echo $row['id'] ?>' class='btn btn-sm btn-danger mt-2'>Delete <i class='fa-solid fa-xmark'></i> </a>
                        </td>
                    </tr>
