...
?>
    <title>Mushfiqur Rohoman Profile</title>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="asset/img/ceo-profile.png" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4 class="fw-bold">Md. Mushfiqur Rahman</h4>
                      <p class="text-secondary mb-1">Founder & Senior Technical Trainer of Networking</p>
                      <p class="text-muted font-size-sm">IT Bangladesh</p>
              ...
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-secondary">www.facebook.com/mushfiq11</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="experience-area">
            ...
            <div class="row my-3">
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title">IDB-BISEW</h5>
                    <p class="card-text">Technical Trainer of Networking Technology</p>
              ...
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-text">Founder & Senior Technical Trainer of Networking</p>
                    <div class="card-footer text-light bg-info">
                       Mar 2014 - Present
                      </div>
                  </div>
            ...
            <div class="row my-3">
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title">BRAC IT Services Limited</h5>
                    <p class="card-text">Ex-Officer of BITS</p>
                      <div class="card-footer text-light bg-info">
                        2015 - July 2016
                      </div>
                  </div>
